  ...
  return (
    <Router>
      <Routes>
        ...
        <Route 
          path="/admin" 
          element={isAuthenticated && user?.isAdmin ? <Admin user={user} /> : <Navigate to="/admin-login" />} 
        />
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Thank you for subscribing. You'll start receiving daily positive psychology activities.</p>
          <a href="/dashboard" className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition">
            Go to Dashboard
          </a>
        </div>
      </div>
